...
const uploadMulter = upload.fields([{ name: 'upload-avartar', maxCount: 1 }, { name: 'upload-background', maxCount: 1 }]);
...
router.post('/edit-profile-process', uploadMulter, userController.edit_profile_process);
