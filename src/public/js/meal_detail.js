...
function getRestaurantLink(link) {
	let restaurant = link.slice(0, link.lastIndexOf('/'));
	restaurant = restaurant.slice(0, restaurant.lastIndexOf('/'));
	restaurant = restaurant.slice(restaurant.lastIndexOf('/') + 1);
	return restaurant;
}
